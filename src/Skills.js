            ...
            <div className="header">
                <div className="htmltag">
                    ...
                    <h1 className="active">
                        ...
                        <span onMouseOver={props.addBoing} onAnimationEnd={props.removeBoing}>Experience</span></h1>
                <div className="htmltag">
                    <p>&lt;h1/&gt;</p>
                </div>
                <div className="text-area">
                    ...
                    <p>Visit my <a href="/contact">LinkedIn</a> profile for more details or just <a href="/contact">contact</a> me.</p>
                </div>
            </div>
        </div>
    )
